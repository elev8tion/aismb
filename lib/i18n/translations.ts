...
export const translations: Record<Language, Translations> = {
  ...
  es: {
    ...
    footer: {
      ...
      links: {
        solutions: [
          { label: 'Agentes de Comunicacion con Clientes', href: '#use-cases' },
          { label: 'Procesamiento Inteligente de Documentos', href: '#use-cases' },
          { label: 'Analitica Predictiva de Negocios', href: '#use-cases' },
          { label: 'Orquestacion Multi-Agente', href: '#use-cases' },
        ],
        company: [
