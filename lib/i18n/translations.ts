...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    hero: {
      badge: 'Trusted to Process $10M+ in Autonomous Transactions — Zero Breaches',
      ...
      stats: {
        agentsBuilt: { value: '$10M+', label: 'Autonomous Transactions' },
        toMastery: { value: '24/7', label: 'Agent Uptime' },
        smbsBuilding: { value: '0', label: 'Data Breaches' },
        buildIndependently: { value: '60%', label: 'Avg Overhead Reduction' },
      },
    },
  ...
  es: {
    ...
    hero: {
      badge: 'Confiables para Procesar $10M+ en Transacciones Autonomas — Cero Brechas',
      ...
      stats: {
        agentsBuilt: { value: '$10M+', label: 'Transacciones Autonomas' },
        toMastery: { value: '24/7', label: 'Disponibilidad del Agente' },
        smbsBuilding: { value: '0', label: 'Brechas de Datos' },
        buildIndependently: { value: '60%', label: 'Reduccion Promedio de Costos' },
      },
    },
    ...
    caseStudies: {
      ...
      heading: 'Infraestructura implementada. Resultados medidos.',
      description:
        'PYMEs reales eliminando overhead y capturando ingresos perdidos con infraestructura de IA soberana. Sin suscripciones. Sin dependencia de proveedores.',
      cases: [
        {
          ...
          timeline: '3 meses',
          challenge:
            'Dueno perdiendo 20-30% de llamadas entrantes. Overhead de administrador de $3,000/mes. Contestador de $500/mes sin calificacion de prospectos.',
          systemsBuilt: [
            'El Guardia de Ingresos — agente de voz 24/7 con calificacion de prospectos',
            'Protocolo de Flujo de Trabajo Soberano — entrada automatica a QuickBooks',
            'Automatizacion de contratos de mantenimiento — ofertas de renovacion proactivas',
          ],
          results: {
          ...
          quote:
            'Deje de pagar $3,500/mes en administracion y contestador. El agente responde mas rapido que cualquier persona. Es mio para siempre.',
          owner: 'Mike T.',
        },
        {
          ...
          timeline: '2 meses',
          challenge:
            'Pasando 10+ horas/semana en tareas repetitivas. $800/mes en suscripciones de software que se superponen. Capacidad limitada para nuevos clientes.',
          systemsBuilt: [
            'Guardia de Ingresos — agente de voz para calificacion de prospectos',
            'Protocolo de Flujo de Trabajo — generacion automatizada de propuestas',
            'Automatizacion de precios y cronogramas',
          ],
          results: {
            timeSaved: '14 horas/semana',
            revenueImpact: 'Propuestas aumentaron de 3/semana a 8/semana',
          ...
          quote:
            'Eliminamos $800/mes en suscripciones de software. El agente de voz califica cada prospecto antes de que hable con nosotros. Puro capital recuperado.',
          owner: 'Sarah K.',
        },
        {
          ...
          timeline: '6 meses',
          challenge:
            'Administrando 180 unidades con procesos manuales. Tres administradores a tiempo completo. Cuotas de software de $2,000/mes. Alta rotacion de inquilinos.',
          systemsBuilt: [
            'Stack multi-agente — coordinacion, renovacion, mantenimiento y evaluacion',
            'Operaciones con Barandillas de Responsabilidad — auditoria de cumplimiento completa',
            'Protocolo de Flujo de Trabajo Soberano — todos los sistemas integrados',
          ],
          results: {
          ...
          quote:
            'Reducimos el overhead de administracion en un 60%. Los agentes son nuestros — no pagamos licencias por usuario a nadie. Esta es infraestructura real.',
          owner: 'James L.',
        },
      ],
      labels: {
        challenge: 'El Sangrado:',
        partnershipTier: 'Nivel de Infraestructura',
        systemsBuiltTogether: 'Infraestructura Implementada',
        measurableResults: 'Capital Recuperado',
        timeSaved: 'Horas Eliminadas',
        roiIn: 'ROI en',
        totalValueCreated: 'Valor Total Creado',
        revenueImpact: 'Ingresos Recuperados',
      ...
      bottomStats: {
        ...
        description:
          'Basado en implementaciones de infraestructura de IA documentadas y estimaciones conservadoras de ROI en todos los tipos de negocios',
        stats: [
          { stat: '10-35 hrs/semana', label: 'Overhead Administrativo Eliminado' },
          { stat: '150-300%', label: 'ROI Promedio (3-6 meses)' },
          { stat: '60%', label: 'Reduccion Promedio de Overhead' },
          { stat: '$0', label: 'Brechas de Datos en Despliegues' },
        ],
        note: 'Estos ejemplos abarcan servicios del hogar, servicios profesionales y bienes raices. Implementamos infraestructura para cualquier tipo de negocio — tu industria es la siguiente.',
      },
    },
