/**
 * Auth Proxy Route - Landing Page to CRM Pipeline
 *
 * PURPOSE: Pipeline User Transition
 * This route enables shared authentication between the landing page (kre8tion.com)
 * and the CRM (app.kre8tion.com). Users who interact with the landing page
 * (voice agent, ROI calculator, calendar booking) can authenticate here and
 * seamlessly access the CRM dashboard without re-authenticating.
 *
 * Data Flow:
 * 1. User completes voice agent session / ROI calc / booking on landing page
 * 2. User signs up/signs in via these auth routes
 * 3. Session cookies are set (shared domain: kre8tion.com)
 * 4. User redirects to app.kre8tion.com with valid session
 *
